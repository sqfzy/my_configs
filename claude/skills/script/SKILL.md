...
```
目标 setup     → Read ~/.claude/skills/script/targets/setup.md
目标 wizard    → Read ~/.claude/skills/script/targets/wizard.md
目标 pipeline  → Read ~/.claude/skills/script/targets/pipeline.md
```
