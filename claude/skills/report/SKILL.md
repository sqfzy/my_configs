...
argument-hint: "[--decision|--status|--incident|--issue|--release|--retro|--experiment|--primer] [--audience dev|user|both] [<主题或补充素材>] [--auto]"
...
- 对工程师（decision / retro / experiment / issue / primer --audience dev）→ 技术细节可以详
